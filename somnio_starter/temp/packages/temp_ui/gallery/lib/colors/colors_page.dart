  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: const EdgeInsets.symmetric(
        horizontal: TEMPSpacing.lg * 2,
        vertical: TEMPSpacing.xs,
      ),
      width: TEMPSpacing.spaceUnit*100,
      height: TEMPSpacing.xxlg,
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.all(
          Radius.circular(TEMPSpacing.xxs * 5),
        ),
      ),
      child: Center(
        child: Text(
          ...
          style: theme.textTheme.labelLarge?.copyWith(
            ...
            color: textColor ?? TEMPColors.black,
          ),
        ),
      ),
    );
