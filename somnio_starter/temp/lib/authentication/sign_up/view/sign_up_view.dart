...
import 'package:temp/authentication/sign_up/bloc/sign_up_bloc.dart';
    ...
    return BlocListener<SignUpBloc, SignUpState>(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: const [
            _NameTextField(),
            SizedBox(height: TEMPSpacing.xlg),
            _EmailTextField(),
            SizedBox(height: TEMPSpacing.xlg),
            _PasswordTextField(),
            SizedBox(height: TEMPSpacing.xlg),
...
class _NameTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      key: const Key('SignUpNameTextField'),
      onChanged: (name) =>
...
class _EmailTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      key: const Key('SignUpEmailTextField'),
      onChanged: (value) =>
...
class _PasswordTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      key: const Key('SignUpPasswordTextField'),
      autocorrect: false,
...
class _ConfirmationPasswordTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      key: const Key('SignUpConfirmationPasswordTextField'),
      autocorrect: false,
      keyboardType: TextInputType.visiblePassword,
