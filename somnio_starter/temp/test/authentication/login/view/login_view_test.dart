...
void main() {
  ...
  group('LoginView', () {
    testWidgets('renders correctly', (WidgetTester tester) async {
      ...
      expect(find.byType(UIOutlinedButton), findsOneWidget);
    });
    ...
    testWidgets('[EmailTextField] should display error state',
      ...
      final emailTextField = find
          ...
          .evaluate()
          .where((element) => element.widget is UITextField)
          .single;
      ...
      final textFieldWidget = emailTextField.widget as UITextField;
