...
Apapa UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── apapa_icons_dark.dart
│   │       │      ├── apapa_icons_light.dart
│   │       │      └── apapa_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── apapa_app_bar.dart
│   │             ├── apapa_outlined_button.dart
│   │             └── apapa_text_field.dart 
│   ├── apapa_ui.dart
│   ├── .gitignore
...
```
2) In `apapa_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `apapa_icons_dark.dart` add the icon with its color respectively of the theme. 
