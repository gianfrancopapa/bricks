## Instagram UI package

Instagram UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── instagram_icons_dark.dart
│   │       │      ├── instagram_icons_light.dart
│   │       │      └── instagram_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── instagram_app_bar.dart
│   │             ├── instagram_outlined_button.dart
│   │             └── instagram_text_field.dart 
│   ├── instagram_ui.dart
│   ├── .gitignore
...
```
2) In `instagram_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `instagram_icons_dark.dart` add the icon with its color respectively of the theme. 
